...
class DeepLabResNetModelRefinement(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        with tf.name_scope('upscale_5_1'):
            (self.feed('res5c_relu',
             ...
             .conv(3, 3, 512, 1, 1, biased=False, relu=False, name='upscale5_1_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale5_1_bn_branch2b')
             .conv(1, 1, 2048, 1, 1, biased=False, relu=False, name='upscale5_1_conv_branch2c')
             .batch_normalization(is_training=is_training, activation_fn=None, name='upscale5_1_bn_branch2c'))

            (self.feed('upscale5_1_bn_branch2c',
                       'res5c_relu')
             .add(name='upscale5_2_add')
        ...
        with tf.name_scope('upscale_5_2'):
            (self.feed('res5b_relu',
             ...
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale5_2_bn_branch2a')
             .conv(3, 3, 512, 1, 1, biased=False, relu=False, name='upscale5_2_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale5_2_bn_branch2b')
             .conv(1, 1, 2048, 1, 1, biased=False, relu=False, name='upscale5_2_conv_branch2c')
             .batch_normalization(is_training=is_training, activation_fn=None, name='upscale5_2_bn_branch2c'))

            (self.feed('upscale5_2_relu',
                       'upscale5_2_bn_branch2c')
             .add(name='upscale5_3_add')
        ...
        with tf.name_scope('upscale_5_3'):
            (self.feed('res5a_relu',
             ...
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale5_3_bn_branch2a')
             .conv(3, 3, 512, 1, 1, biased=False, relu=False, name='upscale5_3_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale5_3_bn_branch2b')
             .conv(1, 1, 2048, 1, 1, biased=False, relu=False, name='upscale5_3_conv_branch2c')
             .batch_normalization(is_training=is_training, activation_fn=None, name='upscale5_3_bn_branch2c'))
        ...
        with tf.name_scope('upscale_4_1'):
            (self.feed('res4b22_relu',
             ...
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_1_bn_branch2a')
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='upscale4_1_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_1_bn_branch2b')
        ...
        with tf.name_scope('upscale_4_2'):
            (self.feed('data_64x64_projected_1024',
                       'res4b18_relu',
                       'upscale4_2_relu')
             .concat(axis=-1, name='upscale4_2_concat')
             .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='upscale4_2_conv_branch2a')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_2_bn_branch2a')
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='upscale4_2_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_2_bn_branch2b')
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='upscale4_2_conv_branch2c')
             .batch_normalization(is_training=is_training, activation_fn=None, name='upscale4_2_bn_branch2c'))

            (self.feed('upscale4_2_relu',
                       'upscale4_2_bn_branch2c')
             .add(name='upscale4_3_add')
        ...
        with tf.name_scope('upscale_4_3'):
            (self.feed('res4b14_relu',
             ...
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_3_bn_branch2a')
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='upscale4_3_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_3_bn_branch2b')
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='upscale4_3_conv_branch2c')
             .batch_normalization(is_training=is_training, activation_fn=None, name='upscale4_3_bn_branch2c'))

            (self.feed('upscale4_3_relu',
                       'upscale4_3_bn_branch2c')
             .add(name='upscale4_4_add')
        ...
        with tf.name_scope('upscale_4_4'):
            (self.feed('res4b10_relu',
             ...
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_4_bn_branch2a')
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='upscale4_4_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_4_bn_branch2b')
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='upscale4_4_conv_branch2c')
             .batch_normalization(is_training=is_training, activation_fn=None, name='upscale4_4_bn_branch2c'))

            (self.feed('upscale4_4_relu',
                       'upscale4_4_bn_branch2c')
             .add(name='upscale4_5_add')
        ...
        with tf.name_scope('upscale_4_5'):
            (self.feed('res4b6_relu',
             ...
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_5_bn_branch2a')
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='upscale4_5_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_5_bn_branch2b')
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='upscale4_5_conv_branch2c')
             .batch_normalization(is_training=is_training, activation_fn=None, name='upscale4_5_bn_branch2c'))

            (self.feed('upscale4_5_relu',
                       'upscale4_5_bn_branch2c')
             .add(name='upscale4_6_add')
        ...
        with tf.name_scope('upscale_4_6'):
            (self.feed('res4b2_relu',
             ...
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_6_bn_branch2a')
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='upscale4_6_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale4_6_bn_branch2b')
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='upscale4_6_conv_branch2c')
             .batch_normalization(is_training=is_training, activation_fn=None, name='upscale4_6_bn_branch2c'))
        ...
        with tf.name_scope('upscale_3_1'):
            (self.feed('upscale3_1_relu',
             ...
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='upscale3_1_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale3_1_bn_branch2b')
        ...
        with tf.name_scope('upscale_2_1'):
            (self.feed('data_128x128_projected_512',
                       'res2c_relu',
                       'upscale2_1_relu_128x128')
             .concat(axis=-1, name='upscale2_1_concat')
             .conv(1, 1, 128, 1, 1, biased=False, relu=False, name='upscale2_1_conv_branch2a')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale2_1_bn_branch2a')
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='upscale2_1_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale2_1_bn_branch2b')
        ...
        with tf.name_scope('upscale_1_1'):
            (self.feed('data_256x256_projected_256',
                       'upscale1_1_relu_256x256')
             .concat(axis=-1, name='upscale1_1_concat')
             .conv(1, 1, 128, 1, 1, biased=False, relu=False, name='upscale1_1_conv_branch2a')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale1_1_bn_branch2a')
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='upscale1_1_conv_branch2b')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='upscale1_1_bn_branch2b')
             .conv(1, 1, num_classes, 1, 1, biased=False, relu=False, name='upscale1_1_conv_branch2c'))
