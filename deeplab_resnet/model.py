...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('fc1_voc12')
         .resize_bilinear(size_h=512, size_w=512, name='fc1_voc12_resized'))
        ...
        (self.feed('concat_input')
         ...
         .conv(1, 1, 32, 1, 1, biased=True, relu=False, name='concat_conv_1', padding='SAME')
         .batch_normalization(is_training=is_training, activation_fn=None, name='concat_conv_1_bn'))

        (self.feed('concat_conv_1_bn')
         .relu(name='concat_conv_2_relu')
         .conv(2, 2, 64, 1, 1, biased=True, relu=False, name='concat_conv_2', padding='SAME')
         .batch_normalization(is_training=is_training, activation_fn=None, name='concat_conv_2_bn'))

        (self.feed('concat_conv_2_bn')
         .relu(name='concat_conv_3_relu')
         .conv(3, 3, 128, 1, 1, biased=True, relu=False, name='concat_conv_3')
         .batch_normalization(is_training=is_training, activation_fn=None, name='concat_conv_3_bn'))

        (self.feed('concat_conv_3_bn')
         .relu(name='concat_conv_4_relu')
         .conv(3, 3, 256, 1, 1, biased=True, relu=False, name='concat_conv_4')
         .batch_normalization(is_training=is_training, activation_fn=None, name='concat_conv_4_bn'))

        (self.feed('concat_conv_4_bn')
         .relu(name='concat_conv_5_relu')
         .conv(3, 3, 128, 1, 1, biased=True, relu=False, name='concat_conv_5')
         .batch_normalization(is_training=is_training, activation_fn=None, name='concat_conv_5_bn'))

        (self.feed('concat_conv_5_bn')
         .relu(name='concat_conv_6_relu')
         .conv(3, 3, 64, 1, 1, biased=True, relu=False, name='concat_conv_6')
         .batch_normalization(is_training=is_training, activation_fn=None, name='concat_conv_6_bn'))

        (self.feed('concat_conv_6_bn')
         .relu(name='concat_conv_7_relu')
         .conv(3, 3, 32, 1, 1, biased=True, relu=False, name='concat_conv_7')
         .batch_normalization(is_training=is_training, activation_fn=None, name='concat_conv_7_bn'))

        (self.feed('concat_conv_7_bn')
         .relu(name='concat_conv_8_relu')
         .conv(3, 3, num_classes, 1, 1, biased=True, relu=False, name='concat_conv_8'))
