...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('pool1') #128*128
             ...
             .conv(1, 1, 320, 1, 1, biased=False, relu=False, name='dense2a_branch2c')
        ...
        (self.feed('bn2a_branch2c')
             ...
             .conv(1, 1, 64, 1, 1, biased=False, relu=False, name='dense2b_branch2c')
        ...
        (self.feed('bn2a_branch2c',
             ...
             .conv(1, 1, 96, 1, 1, biased=False, relu=False, name='dense2c_branch2c')
        ...
        (self.feed('res2c_relu')
             .conv(1, 1, 128, 2, 2, biased=False, relu=False, name='res3a_branch2a') #64*64
             ...
             .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res3a_branch2c')
        ...
        (self.feed('bn3a_branch2c')
             ...
             .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res3b1_branch2c')
        ...
        (self.feed('bn3a_branch2c',
             ...
             .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res3b2_branch2c')
        ...
        (self.feed('bn3b3_branch2c')
             ...
             .conv(1, 1, 384, 1, 1, biased=False, relu=False, name='res4a_branch1')
        ...
        (self.feed('res3b2',
             ...
             .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res4a_branch2c')
        ...
        (self.feed('catres3b3',
             ...
             .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res4b1_branch2c')
        ...
        (self.feed('res4a',
             ...
             .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res4b2_branch2c')
        ...
        (self.feed('res4b1',
             ...
             .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res4b3_branch2c')
        ...
        (self.feed('res4b2',
             ...
             .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res4b4_branch2c')
        ...
        (self.feed('bn4b5_branch2c')
             ...
             .conv(1, 1, 384, 1, 1, biased=False, relu=False, name='res5a_branch1')
        ...
        (self.feed('res4b4',
             ...
             .conv(1, 1, 32, 1, 1, biased=False, relu=False, name='res5a_branch2c')
        ...
        (self.feed('cat5a',
             ...
             .conv(1, 1, 32, 1, 1, biased=False, relu=False, name='res5b_branch2c')
