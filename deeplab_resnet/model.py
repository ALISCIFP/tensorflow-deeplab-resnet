...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('pool1')
         .conv(1, 1, 96, 1, 1, biased=False, relu=False, name='res2a_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2a_branch2a')
         .conv(3, 3, 96, 1, 1, group=32, biased=False, relu=False, name='res2a_branch2b')
        ...
        (self.feed('bn2a_branch2b')
         .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res2a_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2a_branch2c_dense'))
        ...
        (self.feed('res2a_relu',
         ...
         .conv(1, 1, 96, 1, 1, biased=False, relu=False, name='res2b_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2b_branch2a')
         .conv(3, 3, 96, 1, 1, group=32, biased=False, relu=False, name='res2b_branch2b')
        ...
        (self.feed('bn2b_branch2b')
         .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res2b_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2b_branch2c_dense'))
        ...
        (self.feed('res2b_relu',
         ...
         .conv(1, 1, 96, 1, 1, biased=False, relu=False, name='res2c_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2c_branch2a')
         .conv(3, 3, 96, 1, 1, group=32, biased=False, relu=False, name='res2c_branch2b')
        ...
        (self.feed('bn2c_branch2b')
         .conv(1, 1, 16, 1, 1, biased=False, relu=False, name='res2c_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2c_branch2c_dense'))
        ...
        (self.feed('2c_combine_dpn')
         ...
         .conv(3, 3, 192, 1, 1, group=32, biased=False, relu=False, name='res3a_branch2b')
        ...
        (self.feed('bn3a_branch2b')
         .conv(1, 1, 32, 1, 1, biased=False, relu=False, name='res3a_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3a_branch2c_dense'))
        ...
        (self.feed('res3a_relu',
         ...
         .conv(3, 3, 192, 1, 1, group=32, biased=False, relu=False, name='res3b1_branch2b')
        ...
        (self.feed('bn3b1_branch2b')
         .conv(1, 1, 32, 1, 1, biased=False, relu=False, name='res3b1_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b1_branch2c_dense'))
        ...
        (self.feed('res3b1_relu',
         ...
         .conv(1, 1, 192, 1, 1, biased=False, relu=False, name='res3b2_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b2_branch2a')
         .conv(3, 3, 192, 1, 1, group=32, biased=False, relu=False, name='res3b2_branch2b')
        ...
        (self.feed('bn3b2_branch2b')
         .conv(1, 1, 32, 1, 1, biased=False, relu=False, name='res3b2_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b2_branch2c_dense'))
        ...
        (self.feed('res3b1_relu',
         ...
         .conv(1, 1, 192, 1, 1, biased=False, relu=False, name='res3b3_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b3_branch2a')
         .conv(3, 3, 192, 1, 1, group=32, biased=False, relu=False, name='res3b3_branch2b')
        ...
        (self.feed('bn3b3_branch2b')
         .conv(1, 1, 32, 1, 1, biased=False, relu=False, name='res3b3_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b3_branch2c_dense'))
        ...
        (self.feed('3b3_combine_dpn')
         .conv(1, 1, 384, 1, 1, biased=False, relu=False, name='res4a_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4a_branch2a')
         .conv(3, 3, 384, 1, 1, group=32, biased=False, relu=False, name='res4a_branch2b')
        ...
        (self.feed('bn4a_branch2b')
         .conv(1, 1, 24, 1, 1, biased=False, relu=False, name='res4a_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4a_branch2c_dense'))
        ...
        (self.feed('res4a_relu',
         ...
         .conv(3, 3, 384, 1, 1, group=32, biased=False, relu=False, name='res4b1_branch2b')
        ...
        (self.feed('bn4b1_branch2b')
         .conv(1, 1, 24, 1, 1, biased=False, relu=False, name='res4b1_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b1_branch2c_dense'))
        ...
        (self.feed('res4b1_relu',
         ...
         .conv(1, 1, 384, 1, 1, biased=False, relu=False, name='res4b2_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b2_branch2a')
         .conv(3, 3, 384, 1, 1, group=32, biased=False, relu=False, name='res4b2_branch2b')
        ...
        (self.feed('bn4b2_branch2b')
         .conv(1, 1, 24, 1, 1, biased=False, relu=False, name='res4b2_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b2_branch2c_dense'))
        ...
        (self.feed('res4b2_relu',
         ...
         .conv(1, 1, 384, 1, 1, biased=False, relu=False, name='res4b3_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b3_branch2a')
         .conv(3, 3, 384, 1, 1, group=32, biased=False, relu=False, name='res4b3_branch2b')
        ...
        (self.feed('bn4b3_branch2b')
         .conv(1, 1, 24, 1, 1, biased=False, relu=False, name='res4b3_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b3_branch2c_dense'))
        ...
        (self.feed('res4b3_relu',
         ...
         .conv(1, 1, 384, 1, 1, biased=False, relu=False, name='res4b4_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b4_branch2a')
         .conv(3, 3, 384, 1, 1, group=32, biased=False, relu=False, name='res4b4_branch2b')
        ...
        (self.feed('bn4b4_branch2b')
         .conv(1, 1, 24, 1, 1, biased=False, relu=False, name='res4b4_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b4_branch2c_dense'))
        ...
        (self.feed('res4b4_relu',
         ...
         .conv(1, 1, 384, 1, 1, biased=False, relu=False, name='res4b5_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b5_branch2a')
         .conv(3, 3, 384, 1, 1, group=32, biased=False, relu=False, name='res4b5_branch2b')
        ...
        (self.feed('bn4b5_branch2b')
         .conv(1, 1, 24, 1, 1, biased=False, relu=False, name='res4b5_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b5_branch2c_dense'))
        ...
        (self.feed('res4b5_relu',
         ...
         .conv(1, 1, 384, 1, 1, biased=False, relu=False, name='res4b6_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b6_branch2a')
         .conv(3, 3, 384, 1, 1, group=32, biased=False, relu=False, name='res4b6_branch2b')
        ...
        (self.feed('bn4b6_branch2b')
         .conv(1, 1, 24, 1, 1, biased=False, relu=False, name='res4b6_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn4b6_branch2c_dense'))
        ...
        (self.feed('4b6_combine_dpn')
         .conv(1, 1, 768, 1, 1, biased=False, relu=False, name='res5a_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn5a_branch2a')
         .conv(3, 3, 768, 1, 1, group=32, biased=False, relu=False, name='res5a_branch2b')
        ...
        (self.feed('bn5a_branch2b')
         .conv(1, 1, 128, 1, 1, biased=False, relu=False, name='res5a_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn5a_branch2c_dense'))
        ...
        (self.feed('res5a_relu',
         ...
         .conv(3, 3, 768, 1, 1, group=32, biased=False, relu=False, name='res5b_branch2b')
        ...
        (self.feed('bn5b_branch2b')
         .conv(1, 1, 128, 1, 1, biased=False, relu=False, name='res5b_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn5b_branch2c_dense'))
        ...
        (self.feed('res5b_relu',
         ...
         .conv(1, 1, 768, 1, 1, biased=False, relu=False, name='res5c_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn5c_branch2a')
         .conv(3, 3, 768, 1, 1, group=32, biased=False, relu=False, name='res5c_branch2b')
        ...
        (self.feed('bn5c_branch2b')
         .conv(1, 1, 128, 1, 1, biased=False, relu=False, name='res5c_branch2c_dense')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn5c_branch2c_dense'))
