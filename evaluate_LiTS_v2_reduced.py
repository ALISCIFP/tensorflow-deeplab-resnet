...
def get_arguments():
    ...
    parser.add_argument("--nii-dir", type=str, default=NII_DIRECTORY,
                        help="Path to the directory containing the PASCAL VOC dataset.")
...
def saving_process(queue, event, nii_dir, post_processing, restore_from):
    ...
    with open(args.data_list, 'r') as f:
        ...
        with tf.Graph().as_default():
            ...
            proc = Process(target=saving_process, args=(queue_proc, event_end,
                                                        args.nii_dir, args.post_processing, args.restore_from))
            proc.start()
